...
$(document).ready(function(){
	...
	<section class="agent_insert_section">
		<article>
			<h2 class="insert_h2">회원가입</h2>
			<form method="post" action="agent_insert_ok.do">
			<div class="container">
				...
				<div class="form-group">
					<label>중개사등록번호</label><input type="text" name="mediation_num" id="mediation_num" class="form-control" placeholder="중개사 등록 번호를 입력하세요(-를 제외하고 숫자만 입력)">
				</div>
				<div class="form-group">
					<label>사업자등록번호</label><input type="text" name="register_num" id="register_num" class="form-control" placeholder="사업자 등록 번호를 입력하세요(-를 제외하고 숫자만 입력)">
				</div>								
